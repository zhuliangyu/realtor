...
insert into HOUSE_INSPECTION (INSPECTION_ID, INSPECTED_DATE, BUYER_ID, HOUSE_ID, INSPECTOR_ID) values (4, '2019-4-19', 3, 4, 1);

insert into HOUSE_INSPECTION (INSPECTION_ID, INSPECTED_DATE, BUYER_ID, HOUSE_ID, INSPECTOR_ID) values (3, '2019-1-1', 3, 4, 4);

insert into HOUSE_INSPECTION (INSPECTION_ID, INSPECTED_DATE, BUYER_ID, HOUSE_ID, INSPECTOR_ID) values (1, '2019-3-14', 2, 2, 3);

insert into HOUSE_INSPECTION (INSPECTION_ID, INSPECTED_DATE, BUYER_ID, HOUSE_ID, INSPECTOR_ID) values (2, '2019-6-14', 1, 4, 2);

insert into HOUSE_INSPECTION (INSPECTION_ID, INSPECTED_DATE, BUYER_ID, HOUSE_ID, INSPECTOR_ID) values (0, '2019-3-20', 1, 4, 0);
