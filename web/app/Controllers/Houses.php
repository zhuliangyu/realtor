...
class Houses extends BaseController
{
    ...
    {
        $sql_showAll = "SELECT HOUSE_ID, ADDRESS_ID, LISTING_DATE, LISTING_PRICE, SELLER_ID, REALTOR_ID, FLOOR_SPACE, PROPERTY_TYPE_ID FROM `HOUSE` WHERE ADDRESS_ID IS NOT NULL";
